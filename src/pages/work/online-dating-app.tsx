...
const OnlineDatingAppPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Acha Ikeda | {workList[2].title}</title>
        <meta name='description' content={workList[2].description.en} key='desc' />
      </Head>
      <div className='flex flex-col justify-center items-center relative w-screen h-screen'>
        ...
        >
          ...
          <div className='my-5'>
            <WebsiteBtn url={`${workList[2].siteUrl}`} />
          </div>
          <div className='mb-10'>
...
export default OnlineDatingAppPage;
