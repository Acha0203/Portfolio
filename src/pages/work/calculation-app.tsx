...
const CalculationAppPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Acha Ikeda | {workList[6].title}</title>
        <meta name='description' content={workList[6].description.en} key='desc' />
      </Head>
...
export default CalculationAppPage;
