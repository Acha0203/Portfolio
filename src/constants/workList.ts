...
const work5: WorkObj = {
  ...
  description: {
    ja: [
      'コンピュータサイエンス学習プラットフォーム Recursion の課題として作成したオンライン チャット アプリです。「MESSAGE」ボタンをクリックすると、AI 相手に簡単な会話を楽しめます。',
    ],
    en: [
      'This is an online chat application created as an assignment for the computer science learning platform Recursion. When you click the "MESSAGE" button, you can enjoy a simple conversation with an AI.',
    ],
  },
  supplement: {
    ja: [''],
  ...
  technology: {
    ja: [
      'Vue.js、Vuex、そしてリクルートが提供している AI サービス A3RT の Talk API を使用して開発しました。',
    ],
    en: [
      'I developed this app using Vue.js, Vuex, and the Talk API from A3RT, an AI service provided by Recruit.',
    ],
  },
  thumbnailX: 1000,
  thumbnailY: 842,
