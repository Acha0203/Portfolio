...
import SketchJelly from '#/components/sketch-components/SketchJelly';
...
import SketchMortalFlowers from '#/components/sketch-components/SketchMortalFlowers';
...
export const sketchComponentMap: Record<string, ComponentType> = {
  ...
  'mortal-flowers': SketchMortalFlowers,
